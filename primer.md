...
- **Angle mort soulevé, en attente de réponse** : « par jour » pur fait perdre la mise en veille auto de la projection pendant la cérémonie (créneau `projects:false`). Reco = garder UNE exception horaire (fenêtre cérémonie samedi), le reste en jour.
- **En attente du go** : lancer le refactor maintenant, ou boucler d'abord les images de la maquette.
