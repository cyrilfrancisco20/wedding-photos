...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { t: '19h35', label: 'DJ Stéphane annonce la danse des mariés', names: ['Stéphane'] },
      { t: '19h40', bold: true, label: 'Danse des mariés en extérieur', music: 'Oscar Anton · Monde Nouveau', names: ['Stéphane'] },
      { t: '19h45', label: 'DJ Stéphane annonce le lancer de bouquet', names: ['Stéphane'] },
  ...
  },
  {
    ...
    rows: [
      ...
      { t: '20h36', bold: true, label: 'Discours de remerciements · Morgane ou Cyril', sub: 'Nelly remet le micro.', music: 'Khruangbin · August 10', names: ['Nelly', 'Stéphane'] },
